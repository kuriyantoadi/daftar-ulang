...
<head>
  <title>Operator Akuntansi Keluangan Lembaga PPDB SMKN 1 Kragilan</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="container">
    ...
    $result = mysqli_query($koneksi, "SELECT no_p,
      ...
      asal_sekolah,
      id
         FROM t_siswa where kompetensi_keahlian='Akuntansi Keuangan Lembaga' ");
    ...
    $data = mysqli_query($koneksi, "SELECT no_p,
      ...
      kondisi,
      id
        from t_siswa where kompetensi_keahlian='Akuntansi Keuangan Lembaga' LIMIT $mulai, $halperpage ");
    $no = $mulai+1;
        ...
        <tr>
          ...
          <td>
            ...
            if ($d['pdf_daftar_ulang'] == "") {
                echo "<center>Belum Daftar Ulang";
            } else {
                ?>
            <center>
